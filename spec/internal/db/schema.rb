ActiveRecord::Schema.define do
  ...
  create_table :hashable_images, force: true do |t|
    t.references :subject, polymorphic: true
    t.string :img_file_name
    t.string :img_content_type
    t.integer :img_file_size
  ...
  con.create_table :hashable_duplicated_image_hashes do |t|
    t.column :hashable_duplicated_image_id, :integer, null: false
    t.column :mh_hash_vector_binary, :bit, limit: 576

    t.timestamps
  end

  con.create_table :hashable_image_hashes do |t|
    t.column :hashable_image_id, :integer, null: false
    t.column :mh_hash_vector_binary, :bit, limit: 576
